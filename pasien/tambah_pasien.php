...
<head>
  ...
  <title>Klinik RYL | Tambah Data Pasien</title>
              ...
              <form action="aksi_tambah_pasien.php" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Nama" name="nama_pasien" required>
                  </div>


                  <div class="form-group">
                    <label>Tempat Lahir <span class="error">* </span></label>
                    <input type="text" class="form-control" placeholder="Masukkan Tempat Lahir" name="tempat_lahir" required>
                </div>     

                <div class="form-group">
                    <label>Tanggal Lahir <span class="error">* </span></label>
                    <input type="date" class="form-control" placeholder="Masukkan " name="tanggal_lahir" value="<?php echo date('Y-m-d') ?>" required>
                </div> 
