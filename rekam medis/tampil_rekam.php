...
<head>
  ...
  <title>Klinik RYL | Tampil Data Rekam Medis</title>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
        <a href="tambah_rekam.php" class="btn btn-primary">Tambah</a> 
        <a href="pdf_rekam.php" class="btn btn-danger">PDF</a>
...
<?php
include ("../koneksi.php");
$hasil=mysqli_query($koneksi,"SELECT * FROM tb_rekam
...
?>
                ...
                <td><?php echo $no; $no++;?></td>
                  ...
                  <td align="center"><a href="update_rekam.php?hal=update_rekam&id_rekam=<?php echo $data['id_rekam']?>"><button type="button" class="btn btn-success" name=""> 
                  <i class="fa fa-pen"></i> Update</button></a>
                    <a onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" href="hapus_rekam.php?id_rekam=<?php echo $data['id_rekam']?>">
