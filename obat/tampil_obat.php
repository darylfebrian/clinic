...
<head>
  ...
  <title>Klinik RYL | Tampil Data Obat</title>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <a href="pdf_obat.php" class="btn btn-danger">PDF</a>
...
<?php
include ("../koneksi.php");
$hasil=mysqli_query($koneksi,"select * from tb_obat");
$no=1;
...
?>
                ...
                <td><?php echo $no; $no++;?></td>
                  ...
                  <td><?php echo $data['digunakan_oleh']?></td>
                  <td><?php echo $data['manfaat']?></td>

                  
                  <td align="center"><a href="update_obat.php?hal=update_obat&id_obat=<?php echo $data['id_obat']?>"><button type="button" class="btn btn-success" name=""> 
                  <i class="fa fa-pen"></i> Update</button></a>
                    <a onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" href="hapus_obat.php?id_obat=<?php echo $data['id_obat']?>">
